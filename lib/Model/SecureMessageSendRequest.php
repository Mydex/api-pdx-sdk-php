...
/**
 * SecureMessageSendRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SecureMessageSendRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SecureMessageSendRequest';
     ...
     * Sets message_to
     *
     * @param string $message_to Recipient user ID
     *
     * @return self
     */
