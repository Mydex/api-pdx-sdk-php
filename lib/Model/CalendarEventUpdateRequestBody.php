...
/**
 * CalendarEventUpdateRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CalendarEventUpdateRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CalendarEventUpdateRequestBody';
     ...
     * Sets title
     *
     * @param string|null $title Title of the event
     *
     * @return self
     */
     ...
     *
     * @param int|null $start_timestamp Start date and time as Unix timestamp
     *
     * @return self
     */
     ...
     * Sets end_timestamp
     *
     * @param int|null $end_timestamp End date and time as Unix timestamp
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the event
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int $id ID of the calendar-event to be updated
     *
     * @return self
     */
